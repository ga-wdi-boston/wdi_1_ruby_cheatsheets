...
#this is the most basic form of a class
...
#so now if we call the Sports class it looks like this
...
#this is how we would call the class and call the attr_accessor on the new_sport
new_sport = Sports.new
new_sport.players
